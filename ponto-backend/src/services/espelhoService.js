...
const { format, parseISO, differenceInMinutes, startOfMonth, endOfMonth, eachDayOfInterval, isWeekend, addDays } = require('date-fns');
...
module.exports.gerarEspelhoPDF = async (usuarioId, mes) => {
  ...
  for (const dia of diasuteis) {
    ...
    const formatarHora = (m) => m ? format(parseISO(m.dataHoraLocal.toISOString()), 'HH:mm') : '-';
...
module.exports.calcularTerceiroDiaUtil = (ano, mes) => {
